...
class Interceptor extends \Magento\InventoryConfigurableProductAdminUi\Block\Adminhtml\Product\Steps\Bulk implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCaption');
        return $pluginInfo ? $this->___callPlugins('getCaption', func_get_args(), $pluginInfo) : parent::getCaption();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNoImageUrl');
        return $pluginInfo ? $this->___callPlugins('getNoImageUrl', func_get_args(), $pluginInfo) : parent::getNoImageUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParentComponentName');
        return $pluginInfo ? $this->___callPlugins('getParentComponentName', func_get_args(), $pluginInfo) : parent::getParentComponentName();
    }
